...
- ディレクトリ構成は[Note 分類基準]({{< relref "/obsidian/60_Manual_2/61_Notebook/Note 分類基準" >}})を参照
...
[SSH]({{< relref "/obsidian/60_Manual_2/62_Software/SSH" >}}#ssh-config)でgithubのsshを設定しておく。
