...
- Documents(cloud) : メインのディレクトリ。hugoやobsidian、研究室関連のものなどを入れる。長期保管。[Mathematica]({{< relref "/content/60_Manual_2/62_Software/Mathematica" >}})など一部のソフトはデフォルトでここにファイルを保管する。
...
[MXLinux]({{< relref "/content/60_Manual_2/64_OS/MXLinux" >}}#mx-linuxでのsnapの問題)も参考に。
