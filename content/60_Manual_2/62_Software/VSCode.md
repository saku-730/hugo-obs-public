...
VSCode NeovimでNeovimをVSCodeで使える。[Neovim]({{< relref "/content/60_Manual_2/62_Software/Neovim" >}}#vscode-neovim)も参照
...
[VSCode]({{< relref "/content/60_Manual_2/62_Software/VSCode" >}})でNeovimを使えるようにする拡張機能。vimのキーバインドにするのではなく裏側でNeovim自体を起動して使う。
